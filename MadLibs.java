...
class MadLibs { //madlib
    ...
    public void setRandomNums(){
        ...
        //randomNums = "not me, " + "not Hermione, " + "you!";
    }

    //Print instructions to player
    public void printInstructions(){
        System.out.println("Welcome to the MadLibs Game.  If you type in words, we wil give you a story.  Start by typing in a name.");
    }
    ...
    public void enterNoun3(){
        System.out.println("Please enter the last noun");
    ...
    public void createStory(){
        ...
        if (num == 0){
            ...
            " and then at night I gazed at the " + getRandomNums() + " " + getAdjective2() + " fireworks shooting from the "
            + getNoun3() + ".";
        }
        else {
            ...
            + " into the " + getNoun3() + " to get a closer look.  The zoo was " + getAdjective1() + " at night, but they didn't care... "
            + "until " + getRandomNums() + " " + getAdjective2() + " apes yelled in their faces, making Amanda and " + getName() + 
